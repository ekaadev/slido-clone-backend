...
type XPTransaction struct {
	...
	SourceType    string    `gorm:"column:source_type;type:enum('poll','question_created','upvote_received','presenter_validated');not null;index:idx_xp_transactions_source"`
