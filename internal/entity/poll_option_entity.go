...
type PollOption struct {
	...
	VoteCount  int    `gorm:"column:vote_count;type:int;default:0;not null"` // Denormalized
	Order      int    `gorm:"column:order;type:smallint;not null;index:idx_poll_options_order"`
